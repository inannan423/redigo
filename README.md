...
**测试场景包括**:
- Scenario 1-5: 基础操作（SET, GET, PING, HSET, LPUSH）
- Scenario 6: 集合ADD操作 (SADD)
- Scenario 7: 集合MEMBERS操作 (SMEMBERS)  
- Scenario 8: 混合集合操作 (SADD + SMEMBERS)
...
基于 MacBook Pro M2（16GB RAM）的测试结果：

| 命令 | 并发数 | QPS | 平均延迟 | P95 延迟 |
|------|--------|-----|----------|----------|
| PING | 100 | 45,000 | 0.2ms | 0.5ms |
| SET | 50 | 25,000 | 0.8ms | 2.1ms |
| GET | 50 | 28,000 | 0.7ms | 1.8ms |
| HSET | 20 | 18,000 | 1.1ms | 2.8ms |
| HGET | 20 | 20,000 | 1.0ms | 2.5ms |
| SADD | 40 | 22,000 | 0.9ms | 2.3ms |
| SMEMBERS | 30 | 24,000 | 0.8ms | 2.0ms |
